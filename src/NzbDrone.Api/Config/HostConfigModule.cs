...
namespace NzbDrone.Api.Config
{
    public class HostConfigModule : NzbDroneRestModule<HostConfigResource>
    {
            ...
            : base("/config/host")
        {
            ...
            SharedValidator.RuleFor(c => c.Username).NotEmpty().When(c => c.Authentication != AuthenticationType.Disabled);
            SharedValidator.RuleFor(c => c.Password).NotEmpty().When(c => c.Authentication != AuthenticationType.Disabled);
